...
@can('الاشعارات')
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right" id="notification_count">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">الاشعارات</h6>
											<a href="{{route('markasreadaall')}}">
                                               <span class="badge badge-pill badge-warning mr-auto my-auto float-left">تعيين قراءة الكل</span>
											</a>
											
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقروئة: {{Auth()->user()->unreadnotifications->count() }} </p>
									</div>
												...
												<i class="la la-file-alt text-white"></i>
													...
													<div class="mr-3">
															@foreach (Auth()->user()->unreadnotifications as $notifications )
																...
																<div class="notification-subtext">{{ $notifications->created_at->diffForHumans() }}</div>
															@endforeach
													</div> 
											<div class="mr-auto" >
									...
									<div class="main-notification-list" id="unreadNotifications">
											...
											@forelse(Auth()->user()->unreadNotifications as $notification)
													...
													{{-- <a href="{{url('invoicesdetails/'.$notification->data['id'])}}">{{$notification->data['title']}} {{$notification->data['user']}}</a> --}}

													<a class="notification-item" href="{{ url('invoicesdetails/'.$notification->data['id']) }}">
...
/* ألوان حسب النوع */
.notify-icon.paid {
    background: linear-gradient(135deg, #28c76f, #1abc9c);
}

.notify-icon.overdue {
    background: linear-gradient(135deg, #ea5455, #ff7675);
}

.notify-icon.default {
    background: linear-gradient(135deg, #7367f0, #9b59b6);
}
...
@endcan
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/download.png')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/download.png')}}" class=""></div>
