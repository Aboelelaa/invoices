                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                           <div class="form-group">
                                ...
                                <select name="roles_name[]" multiple class="form-control" multiple>
                                    @foreach ($roles as $id => $name)
                                        <option value="{{ $name }}"
                                            {{-- {{ (collect(old('roles_name'))->contains($id)) ? 'selected' : '' }}> --}}
                                            {{ in_array($name, old('roles_name', isset($userRole) ? $userRole : [])) ? 'selected' : '' }}>
                                            {{ $name }}
