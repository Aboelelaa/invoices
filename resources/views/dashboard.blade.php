							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									{{-- @php
										...
										dd(\App\Models\invoices::select('status','value_status')->get());
									@endphp --}}
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
												{{-- @php
													$total = \App\Models\Invoices::count();
													$unpaid = \App\Models\Invoices::where('value_status',2)->count();
												@endphp
												{{ $total > 0 ? round(($unpaid / $total) * 100, 2) : 0 }}% --}}
											     {{ $unpaidPercentage }}%
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7"> 
												{{-- {{\App\Models\invoices::where('value_status',1)->count()}} فواتير --}}
												{{ $paidInvoices }} فواتير
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
												...
												{{-- @php
													$total = \App\Models\Invoices::count();
													$paid = \App\Models\Invoices::where('value_status',1)->count();
												@endphp

                                                {{ $total > 0 ? round(($paid / $total) * 100) : 0 }}% --}}
												 {{ $paidPercentage }}%
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												{{-- {{\App\Models\invoices::where('value_status',3)->count()}} فواتير --}}
												{{ $partialInvoices }} فواتير
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
